...
public class Server {
    ...
    public static void main(String[] args) {
        ...
        try (ServerSocket serverSocket = new ServerSocket(PORT)) {
            ...
            System.out.println("=".repeat(56));
            System.out.printf(" Cong TCP: %d%n", PORT);
            System.out.printf(" Thread Pool: toi da %d luong song song%n", MAX_THREADS);
            System.out.printf(" Giao thuc: Ma hanh dong|{JSON}\\n%n");
            System.out.printf(" Database: %s%n", new java.io.File("user.db").getAbsolutePath());
